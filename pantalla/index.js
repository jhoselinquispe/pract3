...
export const ProfileScreen = ({ Statistic}) => <Screen navigation={navigation} name="Statistic" />;
export const SignOutScreen = ({ navigation}) => <Screen navigation={navigation} name="$ignOut" />;